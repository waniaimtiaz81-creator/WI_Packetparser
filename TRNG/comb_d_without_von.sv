...
`endif
  ...
  dff_logic dff1 (out_pre[0],clk,out[0]);
  dff_logic dff2 (out_pre[1],clk,out[1]);
  dff_logic dff3 (out_pre[2],clk,out[2]);
  dff_logic dff4 (out_pre[3],clk,out[3]);
  dff_logic dff5 (out_pre[4],clk,out[4]);
  dff_logic dff6 (out_pre[5],clk,out[5]);
  dff_logic dff7 (out_pre[6],clk,out[6]);
  dff_logic dff8 (out_pre[7],clk,out[7]);
  dff_logic dff9 (out_pre[8],clk,out[8]);
  dff_logic dff10 (out_pre[9],clk,out[9]);
  dff_logic dff11 (out_pre[10],clk,out[10]);
  dff_logic dff12 (out_pre[11],clk,out[11]);
  dff_logic dff13 (out_pre[12],clk,out[12]);
  dff_logic dff14 (out_pre[13],clk,out[13]);
  dff_logic dff15 (out_pre[14],clk,out[14]);
  dff_logic dff16 (out_pre[15],clk,out[15]);
  dff_logic dff17 (out_pre[16],clk,out[16]);
  dff_logic dff18 (out_pre[17],clk,out[17]);
  dff_logic dff19 (out_pre[18],clk,out[18]);
  dff_logic dff20 (out_pre[19],clk,out[19]);
  dff_logic dff21 (out_pre[20],clk,out[20]);
  dff_logic dff22 (out_pre[21],clk,out[21]);
  dff_logic dff23 (out_pre[22],clk,out[22]);
  dff_logic dff24 (out_pre[23],clk,out[23]);
  dff_logic dff25 (out_pre[24],clk,out[24]);
  dff_logic dff26 (out_pre[25],clk,out[25]);
  dff_logic dff27 (out_pre[26],clk,out[26]);
  dff_logic dff28 (out_pre[27],clk,out[27]);
  dff_logic dff29 (out_pre[28],clk,out[28]);
  dff_logic dff30 (out_pre[29],clk,out[29]);
  dff_logic dff31 (out_pre[30],clk,out[30]);
  dff_logic dff32 (out_pre[31],clk,out[31]);

  assign shift_reg_vld = load;
